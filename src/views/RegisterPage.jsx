        ...
        <div className="absolute top-[40%] transform translate-x-1/4 -translate-y-1/2 w-1/4">
          ...
          <div className="mt-6">
            ...
            <input
              name="imageFile"
              onChange={handleFile}
              class="block w-full text-sm text-gray-900 bg-[#e5f6f0] rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 px-8 py-2"
