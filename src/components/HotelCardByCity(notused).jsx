          ...
          <div>
            ...
            <div className="flex flex-row justify-between">
              <div className="bg-white py-1.5 px-6 rounded-md absolute top-[10px] left-2">
                <p className="text-sm">{ballroom.singleCardContent.cardTitle.string.slice(4)}</p>
              </div>
          ...
          <div className="bg-white absolute top-[168px] left-[6px] px-7 rounded-md">
            <div className="p-2">
              <div className="flex flex-row gap-4 items-center justify-between">
                ...
                <h3 className="text-sm font-semibold">{priceBallroom(ballroom.singleCardContent.commerceInfo?.priceForDisplay?.string)}</h3>
              </div>
            </div>
          </div>
        </div>
