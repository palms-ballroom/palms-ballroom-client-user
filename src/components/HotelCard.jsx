        ...
        <div className="mx-auto container py-8 px-4">
          <div className="flex flex-wrap items-center lg:justify-between justify-center gap-10">
            ...
            <div className="mx-2 w-52 lg:mb-0 mb-8 relative">
              <div>
                <img
                  src="https://images.unsplash.com/photo-1567807052979-c991f0635b54?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80"
                  className="w-full h-[230px] bg-cover bg-no-repeat rounded-xl shadow-lg"
                />
                <div className="flex flex-row justify-between">
                  <div className="bg-white py-1.5 px-6 rounded-md absolute top-[10px] left-2">
                    <p className="text-xs text-indigo-700">Jakarta</p>
                  </div>
              ...
              <div className="bg-white absolute top-[168px] left-[6px] px-7 rounded-md">
                <div className="p-2">
                  <div className="flex flex-row gap-4 items-center justify-between">
                    ...
                    <h3 className="text-indigo-700 text-sm font-semibold">
                      Rp. 50000
                    </h3>
                  </div>
                </div>
