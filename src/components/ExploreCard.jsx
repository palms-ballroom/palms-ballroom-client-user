  ...
  return (
    <>
      <div className="flex flex-row p-2">
        <div className="bg-orange-50 h-96 w-[800px]">
          <p className="text-3xl px-4 py-16 font-bold font-title">
            Explore your city here!
          </p>
        </div>
        <div className="flex flex-row justify-between items-center gap-8 absolute top-[1780px] left-[440px]">
          <img
