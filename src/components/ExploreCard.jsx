  ...
  return (
    <>
      <div className="flex flex-row p-2">
        <div className="bg-orange-50 2xl:h-96 2xl:w-[800px] xl:h-80 xl:w-[600px]">
          <p className="xl:text-2xl 2xl:text-3xl px-4 py-16 font-bold font-title">
            Explore your city here!
          </p>
        </div>
        <div className="flex flex-row justify-between items-center gap-8 absolute xl:top-[1650px] xl:left[30px] 2xl:top-[1780px] 2xl:left-[440px]">
          <img
